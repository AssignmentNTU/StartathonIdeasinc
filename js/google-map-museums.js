function initMap() {
    ...
    var arrays     = ['ChIJ69IuoA0Z2jERi_Q7GmHkApA',
        'ChIJFQzeR6cZ2jERgM6--iWeY-U',
        'ChIJoZOhmQkZ2jERehLfvKlsoCA',
        'ChIJW8o1nqQZ2jERynZN2M1BODM',
        'ChIJWZX956MZ2jERIGdnbs_SgMw',
        'ChIJ0dqtSpWd44kRebjZu3Uhy2I',
        'ChIJnWdQKQQZ2jERScXuKeFHyIE',
        'ChIJlcijSfYa2jERGZ3CD7lpz_E',
        'ChIJU-yCOrEZ2jER9h_JbDNPFBQ',
        'ChIJReT1YyMa2jER47ZxHy6cwRc'];
    var places     = [];
    var address    = [];
    var p = 0;
